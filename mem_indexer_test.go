...
func Test_kIndexTable_Add(t *testing.T) {
	...
	assert.Equal(t, int64(6), zeroIdx.imap["state:CA"].Items[0].ConjunctionID)
	assert.Equal(t, false, zeroIdx.imap["state:CA"].Items[0].Contains)
	assert.Equal(t, int64(6), zeroIdx.imap["state:NY"].Items[0].ConjunctionID)
	assert.Equal(t, false, zeroIdx.imap["state:NY"].Items[0].Contains)
	assert.Equal(t, int64(6), zeroIdx.imap["null:null"].Items[0].ConjunctionID)
	...
	assert.Equal(t, int64(5), oneIdx.imap["age:3"].Items[0].ConjunctionID)
	assert.Equal(t, true, oneIdx.imap["age:3"].Items[0].Contains)
	assert.Equal(t, int64(5), oneIdx.imap["age:4"].Items[0].ConjunctionID)
	...
	assert.Equal(t, int64(1), twoIdx.imap["state:NY"].Items[0].ConjunctionID)
	assert.Equal(t, true, twoIdx.imap["state:NY"].Items[0].Contains)

	assert.Equal(t, int64(1), twoIdx.imap["age:3"].Items[0].ConjunctionID)
	assert.Equal(t, true, twoIdx.imap["age:3"].Items[0].Contains)
	assert.Equal(t, int64(2), twoIdx.imap["age:3"].Items[1].ConjunctionID)
	assert.Equal(t, true, twoIdx.imap["age:3"].Items[1].Contains)
	assert.Equal(t, int64(3), twoIdx.imap["age:3"].Items[2].ConjunctionID)
	assert.Equal(t, true, twoIdx.imap["age:3"].Items[2].Contains)

	assert.Equal(t, int64(2), twoIdx.imap["gender:F"].Items[0].ConjunctionID)
	assert.Equal(t, true, twoIdx.imap["gender:F"].Items[0].Contains)

	assert.Equal(t, int64(3), twoIdx.imap["state:CA"].Items[0].ConjunctionID)
	assert.Equal(t, false, twoIdx.imap["state:CA"].Items[0].Contains)
	assert.Equal(t, int64(4), twoIdx.imap["state:CA"].Items[1].ConjunctionID)
	assert.Equal(t, true, twoIdx.imap["state:CA"].Items[1].Contains)

	assert.Equal(t, int64(3), twoIdx.imap["gender:M"].Items[0].ConjunctionID)
	assert.Equal(t, true, twoIdx.imap["gender:M"].Items[0].Contains)
	assert.Equal(t, int64(4), twoIdx.imap["gender:M"].Items[1].ConjunctionID)
